...
const useFilmDetailSearch = () => {
    const [fetchedFilmsMore, setFetchedFilmsMore] = useState({});

    const searchFilmDetailsMore = async (filmId) => {
        const options = {
            method: 'GET',
            headers: {
    ...
    return {fetchedFilmsMore, searchFilmDetailsMore};
};

export default useFilmDetailSearch;
